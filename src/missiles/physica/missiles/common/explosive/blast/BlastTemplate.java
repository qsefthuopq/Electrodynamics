...
public class BlastTemplate {
	...
	public void end(World world, Location loc, IStateHolder holder)
	{
	}

	public void pushEntities(World world, Location loc, float radius, float force, boolean drawTowards)
	{
