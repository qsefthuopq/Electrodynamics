...
public class BlockPrimedBlock extends Block {
	...
	public void registerBlockIcons(IIconRegister register)
	{
		for (Explosive ex : Explosive.explosiveSet)
		{
			if (ex.hasBlock)
			{
				topIcons.add(ex.getId(), register.registerIcon(CoreReferences.PREFIX + "explosives/blocks/" + ex.getTopIcon()));
				sideIcons.add(ex.getId(), register.registerIcon(CoreReferences.PREFIX + "explosives/blocks/" + ex.getSideIcon()));
				bottomIcons.add(ex.getId(), register.registerIcon(CoreReferences.PREFIX + "explosives/blocks/" + ex.getBottomIcon()));
			} else
			{
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack itemStack)
	{
		...
		} else
		{
			...
			{
				Location position = new Location(x, y, z).OffsetFace(face);
